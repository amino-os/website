...
+++
Amino OS is an umbrella project the goal of which is to create a distributed platform for coding and running distributed (cloud, edge and mobile)  applications. It has four main components:
<ul>
	<li>Amino.Run: A distributed microservice runtime</li>
	<li>Amino.Sync: A reactive data synchronization service that provides configurable consistency guarantees</li>
